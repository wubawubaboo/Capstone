...
export default function MediationCalendar() {
    const events = {
        1: { title: '9:00 AM\nJuan Dela Cruz', color: 'bg-emerald-100 text-emerald-800' },
        18: { title: '2:00 PM\nAnnette Santos', color: 'bg-pink-100 text-pink-800' },
        20: { title: '10:00 AM\nDianne Cruz', color: 'bg-amber-100 text-amber-800' },
        26: { title: '3:00 PM\nWade Reyes', color: 'bg-rose-100 text-rose-800' },
    };
                    ...
                    {days.map((day, idx) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {event && (
                                    <div className={`p-1.5 rounded text-[10px] font-medium leading-tight whitespace-pre-line ${event.color}`}>
                                        {event.title}
                                    </div>
                                )}
                            </div>
