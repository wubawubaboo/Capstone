        ...
        <div className="flex flex-col items-center pt-6 px-2 pb-4">
            ...
            <div className="w-full">
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    <Link href="/hotlines" className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center text-center justify-center min-h-[100px] hover:border-blue-500 hover:shadow-md transition-all">
                        <div className="text-2xl mb-2">📞</div>
